...
*/
        ...
        http.authorizeHttpRequests((auth) -> auth
                ...
                .antMatchers(HttpMethod.GET, "/api/courses/**").hasAnyRole("ALUMNO", "PROFESSOR", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api/courses/**").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/courses/**").hasAnyRole("ADMIN")

                .antMatchers(HttpMethod.GET, "/api/professors/**").hasAnyRole("PROFESSOR", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api/professors/**").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/professors/**").hasAnyRole("ADMIN")

                .antMatchers(HttpMethod.GET, "/api/reviewComments/**").hasAnyRole("PROFESSOR", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api/reviewComments/**").hasAnyRole("ALUMNO", "PROFESSOR", "ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/reviewComments/**").hasAnyRole("PROFESSOR", "ADMIN")

                .antMatchers(HttpMethod.GET, "/api/reviews/**").hasAnyRole("ALUMNO", "PROFESSOR", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api/reviews/**").hasAnyRole("PROFESSOR", "ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/reviews/**").hasAnyRole("PROFESSOR", "ADMIN")

                .antMatchers(HttpMethod.GET, "/api/universities/**").hasAnyRole("ALUMNO", "PROFESSOR", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api/universities/**").hasAnyRole( "ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/universities/**").hasAnyRole( "ADMIN")
